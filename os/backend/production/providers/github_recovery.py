...
def recover_failed_github_result(result_id, job, client=None, recovery_run_id=None, recovery_artifact=None):
    ...
    try:
        ...
        promotion=promote_artifact_to_pages(source_run_id=recovery_run_id,artifact_name=artifact['name'],asset_path='final-output.mp4',asset_filename='short13.mp4',client=client,monitor=monitor,verify_url=True)
